...
describe('SQLite schema migrations', () => {
  ...
  test('contains columns introduced by incremental media and metadata migrations', () => {
    ...
    for (const column of ['playback_filename', 'checksum', 'recognition_status', 'background_filename', 'playback_preferred', 'source_duration', 'artifact_type', 'artifact_notes', 'artifact_crop_x', 'artifact_crop_y', 'artifact_zoom']) assert.ok(mediaColumns.has(column), column);
