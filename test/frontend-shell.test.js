...
describe('frontend shell contracts', () => {
  test('declares every navigable page before styles load to prevent a flash of all pages', () => {
    const routes = ['/overview', '/artists', '/venues', '/artifacts', '/artifact', '/timeline', '/search', '/health', '/maintenance', '/activity', '/conflicts', '/api-limits', '/shows', '/artist', '/show', '/playback', '/city', '/edit', '/venue', '/add', '/map', '/account'];
