...
describe('frontend shell contracts', () => {
  ...
  test('loads shared frontend modules before the application bundle', () => {
    for (const module of ['api-client', 'page-runtime', 'formatters', 'navigation', 'auth-state', 'jobs', 'shows', 'show-cards', 'playback-core', 'playback-media', 'playback-editor', 'theatre', 'media-ui', 'media-uploader', 'media-gallery', 'upload-queue', 'media-jobs', 'show-editor', 'directory-ui']) {
      assert.ok(html.indexOf(`/lib/${module}.js`) < html.indexOf('/app.js'), module);
    }
    for (const global of ['MasterListApiClient', 'MasterListPageRuntime', 'MasterListFormatters', 'MasterListNavigation', 'MasterListAuthState', 'MasterListJobs', 'MasterListShows', 'MasterListShowCards', 'MasterListPlaybackCore', 'MasterListPlaybackMedia', 'MasterListPlaybackEditor', 'MasterListTheatre', 'MasterListMediaUi', 'MasterListMediaUploader', 'MasterListMediaGallery', 'MasterListUploadQueue', 'MasterListMediaJobs', 'MasterListShowEditor', 'MasterListDirectoryUi']) {
