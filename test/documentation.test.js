...
test('the environment template covers every operator-facing runtime setting', () => {
  ...
  const expected = [
    ...
    'CONNECTIONS_ENCRYPTION_KEY', 'CONNECTIONS_ENCRYPTION_KEY_PREVIOUS', 'INSTANCE_NAME', 'PEER_SYNC_ENABLED', 'PEER_SYNC_INTERVAL_SECONDS',
    ...
    'MASTER_LIST_DATA_DIR', 'MASTER_LIST_MEDIA_DIR', 'MASTER_LIST_MEDIA_PATH',
    'BACKUP_ENABLED', 'BACKUP_INTERVAL_HOURS', 'BACKUP_RETENTION_COUNT', 'MASTER_LIST_BACKUP_DIR', 'MASTER_LIST_BACKUP_PATH'
  ];
