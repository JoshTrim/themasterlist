function createMaintenanceRoutes({ requireAccount, readBody, sendJson, sendError, status, settings, setSetting, pruneBackups, createBackup, manifest, integrity, restore }) {
