function createMaintenanceRoutes({ requireAccount, readBody, sendJson, sendError, status, diagnostics, settings, setSetting, pruneBackups, createBackup, manifest, integrity, restore, exportInstance, importInstance, importInstanceChunk }) {
