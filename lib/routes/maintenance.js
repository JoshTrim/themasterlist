function createMaintenanceRoutes({ requireAccount, readBody, sendJson, sendError, status, diagnostics, updateStatus, settings, setSetting, pruneBackups, createBackup, manifest, integrity, restore, exportInstance, importInstance, importInstanceChunk }) {
