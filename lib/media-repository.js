function createMediaRepository({ database, mediaDir, path, existsSync, statSync }) {
  function format(media) {
    ...
    return {
      ...
      artifactIsCover: Boolean(media.artifactIsCover),
