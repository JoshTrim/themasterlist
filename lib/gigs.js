  ...
  async function writeAll(gigs) {
    const insert = database.prepare(`
      ...
      VALUES (@id, @sharedId, @artist, @venue, @city, @date, @notes, @performanceNotes, @venueNotes,
        @performanceRating, @venueRating, @favorite, @setlistFmId, @setlistFmUrl, @songs, @acts, @attendees, @createdAt)
      ON CONFLICT(id) DO UPDATE SET
        ...
        setlist_fm_id = excluded.setlist_fm_id, setlist_fm_url = excluded.setlist_fm_url, songs = excluded.songs, acts = excluded.acts, attendees = excluded.attendees
    `);
