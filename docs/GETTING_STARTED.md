...
5. Open the saved show to edit tracks, assign media, add artifacts or build whole-set playback. Artifact cards can hold separate front, back and named detail photos; open a card to flip between them.
