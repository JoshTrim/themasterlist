...
The remaining backend code should move in behavior-preserving slices: show/media repositories and routes, peer transport/signing, external integrations, metadata providers, then the HTTP composition root. The remaining frontend should be separated by page/workflow after browser-level tests are introduced.
